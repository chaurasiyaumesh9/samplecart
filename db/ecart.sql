...
----------- table products ----------------
	create table products( id INT NOT NULL PRIMARY KEY,category_id INT NOT NULL, name varchar(255) NOT NULL, SKU varchar(255) NOT NULL, price DECIMAL(10, 2) NOT NULL, quantity INT NOT NULL, enabled boolean NOT NULL, decription text, short_description text );
